...
-- Go to the start of the line with gh in normal and visual mode
vim.api.nvim_set_keymap('n', 'gh', '^', { desc = 'Go to the start of line', noremap = true, silent = true })
vim.api.nvim_set_keymap('v', 'gh', '^', { desc = 'Go to the start of line', noremap = true, silent = true })

-- Go to the end of the line with gl in normal and visual mode
...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- Set highlights to ensure transparency works well.
